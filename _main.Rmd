...
<!--chapter:end:01-ShortReadsMapping.Rmd-->
...
#### /!\\ Strict method must be favored {-}

### The strict method {-}

For SNPs, all sites with `*` as genotype (= position is overlapping a deletion) or not `SNP`as type will be excluded with the command `bcftools view -e 'ALT="*" || type!="snp"'`. 
...
<!--chapter:end:03-SNPfiltering.Rmd-->
